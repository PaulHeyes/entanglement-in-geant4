 ...
 #ifndef BoringComptonModel_h
 #define BoringComptonModel_h 1
 ...
 class BoringComptonModel : public G4VEmModel
 {

 public:

   BoringComptonModel(const G4ParticleDefinition* p = 0,
                                    const G4String& nam = "QECorrelatedCompton");

   virtual ~BoringComptonModel();
 ...
 private:
   ...
   BoringComptonModel & operator=(const  BoringComptonModel &right);
   BoringComptonModel(const  BoringComptonModel&);
