...
//Constructor
BellsActionInitialization::BellsActionInitialization()
...
void BellsActionInitialization::BuildForMaster() const
{
  SetUserAction(new BellsRunAction);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void BellsActionInitialization::Build() const
{
  SetUserAction(new BellsPrimaryGeneratorAction);
  SetUserAction(new BellsRunAction);
  SetUserAction(new EventAction);
  SetUserAction(new BellsStackingAction);
}  
